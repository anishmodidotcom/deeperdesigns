...
export const SHOWCASES: Showcase[] = [
  ...
  },
  {
    ...
    cardLabel: "An AI engine custom-built for one brand at a time",
    cardDescription: "Installed once. Trained on your voice. Generates strategic content forever.",
    outcome: "Strategic content, in your brand voice, on demand",
    live: true,
