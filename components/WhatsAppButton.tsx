  ...
  return (
    <>
      ...
      <a
        ...
        style={{ position: "fixed", bottom: "24px", right: "24px", zIndex: 40, width: "56px", height: "56px", background: "var(--dd-indigo, #7C6CFF)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 24px rgba(124,108,255,0.4)", transition: "transform 200ms" }}
      >
