...
// One-off: fresh full-page screenshots of the three finished v19.5 /for pages
// (ca-firms, salons, logistics), for review + marketing reuse. Run against a
// local `bun run start`. Not part of the build.
import { chromium } from "playwright";
import { mkdirSync } from "node:fs";

const BASE = process.env.BASE_URL ?? "http://localhost:3210";
const SLUGS = ["ca-firms", "salons", "logistics"];
