...
export default function KhataDemo() {
  return (
    <main
      data-demo-screen
      style={
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "16px 12px 12px", background: HEADER }}>
        ...
        <div
          ...
          style={{
            ...
            height: 38,
            borderRadius: "50%",
            background: "linear-gradient(150deg, #C9A227, #8C6E14)",
            display: "flex",
            alignItems: "center",
      ...
      >
        ...
        <div style={{ alignSelf: "flex-end", maxWidth: "84%" }}>
          <div style={{ background: OUT_BUBBLE, borderRadius: "8px 8px 4px 8px", padding: 4, boxShadow: "0 1px 1px rgba(0,0,0,0.18)" }}>
            <div style={{ borderRadius: 6, overflow: "hidden", background: "rgba(0,0,0,0.16)", padding: "12px 12px 8px" }}>
              <p style={{ margin: 0, color: "#FFE9A8", fontSize: 12, fontWeight: 600, fontFamily: "var(--font-geist-mono), monospace", letterSpacing: "0.04em" }}>
                GOLD-SAVINGS SCHEME · 9 OF 11
              </p>
              <p style={{ margin: "8px 0 0", color: "#E9EDEF", fontSize: 14.5, lineHeight: 1.45 }}>
                Your monthly instalment of <b style={{ fontWeight: 600 }}>Rs 5,000</b> is due. Pay now and your maturity bonus stays on track for Diwali.
              </p>
              <div style={{ marginTop: 10, height: 6, borderRadius: 999, background: "rgba(255,255,255,0.16)", overflow: "hidden" }}>
                <div style={{ width: "82%", height: "100%", background: "#FFD24D", borderRadius: 999 }} />
              </div>
              <p style={{ margin: "7px 0 0", color: "#C9D8D2", fontSize: 12 }}>Rs 45,000 saved so far</p>
            </div>
            <Meta time="10:02" />
          </div>
        </div>
        ...
        <div style={{ alignSelf: "flex-end", width: "84%", marginTop: 2 }}>
          ...
          >
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke={LINK} strokeWidth="2.2" aria-hidden>
        ...
        <OutBubble time="10:02">
          Also, your daughter&apos;s wedding-season collection is ready to view whenever you visit. We have kept a few Polki sets aside.
        </OutBubble>

        {/* Customer reply */}
        <InBubble time="10:14">Paid just now. Will come Saturday to see the sets.</InBubble>
      </div>
