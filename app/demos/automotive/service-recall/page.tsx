...
// Real full-screen demo: a WhatsApp Business service-due recall from "Highway
// Motors" to a customer with a booking button. Same fidelity as the D2C chat.
// Not indexed.
export const metadata: Metadata = {
  title: "Service Recall demo",
...
export default function ServiceRecallDemo() {
  return (
    <main
      data-demo-screen
      style={
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "16px 12px 12px", background: HEADER }}>
        ...
        <div aria-hidden style={{ width: 38, height: 38, borderRadius: "50%", background: "linear-gradient(150deg, #C92A2A, #8A1A1A)", display: "flex", alignItems: "center", justifyContent: "center", color: "#FFFFFF", fontWeight: 600, fontSize: 15, flexShrink: 0 }}>H</div>
        <div style={{ flex: 1, minWidth: 0, lineHeight: 1.2 }}>
          <p style={{ margin: 0, color: "#E9EDEF", fontSize: 16, fontWeight: 600 }}>Highway Motors</p>
      ...
      <div style={{ flex: 1, overflowY: "auto", background: CHAT_BG, backgroundImage: DOODLE, backgroundSize: "90px 90px", padding: "14px 14px 6px", display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        <OutBubble time="11:05">Hello Mr Nair, a reminder from Highway Motors service.</OutBubble>
        ...
        <div style={{ alignSelf: "flex-end", maxWidth: "84%" }}>
          <div style={{ background: OUT_BUBBLE, borderRadius: "8px 8px 4px 8px", padding: 4, boxShadow: "0 1px 1px rgba(0,0,0,0.18)" }}>
            <div style={{ borderRadius: 6, overflow: "hidden", background: "rgba(0,0,0,0.16)", padding: "12px 12px 10px" }}>
              <p style={{ margin: 0, color: "#F2B8B8", fontSize: 12, fontWeight: 600, fontFamily: "var(--font-geist-mono), monospace", letterSpacing: "0.04em" }}>SERVICE DUE</p>
              <p style={{ margin: "8px 0 0", color: "#E9EDEF", fontSize: 14.5, lineHeight: 1.45 }}>
                Your <b style={{ fontWeight: 600 }}>Creta (KA01 AB 4412)</b> is due for its 20,000 km service. Tap to book a slot, free pickup and drop included.
              </p>
            </div>
            <Meta time="11:05" />
          </div>
        ...
        <div style={{ alignSelf: "flex-end", width: "84%", marginTop: 2 }}>
          <button style={{ width: "100%", background: IN_BUBBLE, color: LINK, fontSize: 14.5, fontWeight: 600, padding: "12px", borderRadius: 8, border: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, cursor: "pointer" }}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke={LINK} strokeWidth="2.2" aria-hidden><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>
            Book a service slot
          </button>
        </div>

        <InBubble time="11:12">Saturday morning works.</InBubble>
          ...
          <div style={{ background: OUT_BUBBLE, borderRadius: "8px 8px 4px 8px", padding: 4, boxShadow: "0 1px 1px rgba(0,0,0,0.18)" }}>
            <div style={{ borderRadius: 6, overflow: "hidden", background: "rgba(0,0,0,0.16)", padding: "12px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                ...
                <span style={{ color: "#7BE0A0", fontSize: 13.5, fontWeight: 600 }}>Slot confirmed</span>
              </div>
              <p style={{ margin: 0, color: "#D7E4DE", fontSize: 13 }}>Sat 21st, 9:30 AM · pickup at 9:00 AM · est. Rs 6,800</p>
            </div>
            <Meta time="11:12" />
          </div>
        </div>
