...
// Real full-screen demo: the Dish Studio for "Tinda House". A raw phone food
// photo turned into menu-grade shots and a reel frame (real generated
// images). Not indexed; kept for reuse.
export const metadata: Metadata = {
  title: "Dish Studio demo",
...
const OUTPUTS = [
  { src: "/builds/restaurants/studio/dish-hero.webp", label: "Hero", alt: "Menu-grade hero shot of the chicken biryani in a copper handi" },
  { src: "/builds/restaurants/studio/dish-topdown.webp", label: "Top-down", alt: "Top-down menu shot of the biryani with raita and salan" },
  { src: "/builds/restaurants/studio/dish-reel.webp", label: "Reel frame", alt: "Vertical reel frame of a spoon lifting biryani with steam" },
];

const PRESETS = ["Hero", "Top-down", "Reel frame", "Flat lay", "Festive"];

export default function DishStudioDemo() {
  return (
    <main
      data-demo-screen
      style={
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 28px", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 12 }}>
          ...
          <h1 style={{ margin: 0, fontSize: 20, fontWeight: 600, letterSpacing: "-0.02em" }}>Dish Studio</h1>
          <span style={{ fontSize: 13, color: "#6B6B6B" }}>Tinda House · Hyderabadi Chicken Biryani</span>
        </div>
        <span style={{ background: ACCENT, color: "#0A0A0A", fontSize: 14, fontWeight: 600, padding: "10px 22px", borderRadius: 999 }}>Generate shots</span>
      </div>
      ...
      <div style={{ flex: 1, display: "grid", gridTemplateColumns: "360px 1fr", minHeight: 0 }}>
        ...
        <div style={{ borderRight: "1px solid rgba(255,255,255,0.08)", padding: "20px 24px", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ borderRadius: 14, overflow: "hidden", border: "1px solid rgba(255,255,255,0.08)", background: "#111111" }}>
            <Image
              src="/builds/restaurants/studio/dish-raw.webp"
              alt="Amateur phone photo of a plate of biryani under flat tube-light"
              width={312}
              height={416}
            ...
            <div style={{ padding: "12px 14px", display: "flex", alignItems: "center", gap: 9 }}>
              ...
              <span style={{ fontSize: 12.5, color: "#A8A8A8" }}>uploaded · kitchen photo</span>
            </div>
          </div>
          <p style={{ marginTop: 18, fontSize: 13, lineHeight: 1.55, color: "#6B6B6B" }}>
            One quick photo from the pass. The studio relights it, plates it, and keeps the dish itself exactly as it is served.
          </p>
        </div>
        ...
        <div style={{ padding: "20px 28px", display: "flex", flexDirection: "column", minHeight: 0 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
            ...
            <span style={{ fontSize: 11.5, color: "#6B6B6B", fontFamily: "var(--font-geist-mono), monospace" }}>3 OF 10 SHOTS</span>
          </div>
