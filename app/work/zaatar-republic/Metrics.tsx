    ...
    >
      ...
      >
        <div>
          ...
          <p style={labelStyle}>Food waste reduced</p>
        </div>
        ...
        >
          <p style={numberStyle}>AED 14K</p>
          <p style={labelStyle}>Monthly savings on over-ordering</p>
        </motion.div>
        ...
        >
          <p style={numberStyle}>Real-time</p>
          <p style={labelStyle}>Margin visibility per dish</p>
        </motion.div>
        ...
        >
          ...
          <p style={labelStyle}>Locations managed from one screen</p>
        </motion.div>
      </div>
